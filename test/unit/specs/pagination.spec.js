...
describe('Pagination', () => {
  ...
  it('create', () => {
    ...
    // pager
    expect(elm.querySelector('ul.hf-ui-pager')).to.exist;
    // next
    expect(elm.querySelector('button.btn-next')).to.exist;
    // jumper
    expect(elm.querySelector('.hf-ui-pagination__jump')).to.exist;
    // ->
    expect(elm.querySelector('.hf-ui-pagination__rightwrapper')).to.exist;
  });
  ...
  it('set layout', () => {
    ...
    expect(elm.querySelector('button.btn-next')).to.exist;
    // not found jumper
    expect(elm.querySelector('.hf-ui-pagination__jump')).to.not.exist;
    // not found ->
    expect(elm.querySelector('.hf-ui-pagination__rightwrapper')).to.not.exist;
    // not found total
    expect(elm.querySelector('.hf-ui-pagination__total')).to.not.exist;
  });
  ...
  it('layout: all in right, need clear float', () => {
    ...
    const elm = vm.$el;
    const right_div = elm.querySelector('.hf-ui-pagination__rightwrapper');
  ...
  it('small', () => {
    ...
    expect(vm.$el.classList.contains('hf-ui-pagination--small')).to.true;
  });
  ...
  it('currentPage', () => {
    ...
    expect(Number(vm.$el.querySelector('li.number.active').textContent)).to.equal(3);
  });
  ...
  it('currentPage: NaN', () => {
    ...
    expect(Number(vm.$el.querySelector('li.number.active').textContent)).to.equal(1);
  ...
  it('set currentPage & total', (done) => {
    ...
    expect(Number(vm.$el.querySelector('li.number.active').textContent)).to.equal(10);
    vm.resetTotal();
    setTimeout(() => {
      expect(Number(vm.$el.querySelector('li.number.active').textContent)).to.equal(1);
      done();
  ...
  //   expect(vm.$el.querySelector('.hf-ui-select-dropdown__item.selected')).to.property('textContent').include('35');
  //   expect([].slice.call(vm.$el.querySelectorAll('.hf-ui-select-dropdown__item'))
  ...
  //   expect(vm.$el.querySelector('.hf-ui-select-dropdown__item.selected')).to.property('textContent').include('10');
  // });
  ...
  //   setTimeout(() => {
  //     vm.$el.querySelectorAll('li.hf-ui-select-dropdown__item')[1].click();
  //     setTimeout(() => {
  ...
  it('pageSize > total', () => {
    ...
    const input = vm.$el.querySelector('.hf-ui-pagination__jump input');
  ...
  describe('click pager', () => {
    it('click ul', () => {
      ...
      vm.$el.querySelector('.hf-ui-pager').click();
    ...
    it('click li', () => {
      ...
      vm.$el.querySelectorAll('.hf-ui-pager li.number')[1].click();
    ...
    it('click next icon-more', () => {
      ...
      vm.$el.querySelector('.hf-ui-pager .more').click();
      expect(vm.internalCurrentPage).to.equal(5);
    });
