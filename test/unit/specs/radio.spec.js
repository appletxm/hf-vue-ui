import { createVue, destroyVM, triggerKeyDown, wait } from '../util';

const {prefix} = require('component-cfg')
...
describe('Radio', () => {
  ...
  it('create', done => {
    vm = createVue({
      template: `
        <${prefix}-radio v-model="radio" label="a">
        </${prefix}-radio>
      `,
      data() {
        return {
    ...
    let radioElm = vm.$el;
    expect(radioElm.classList.contains(`${prefix}-radio`)).to.be.true;
    radioElm.click();
    setTimeout(_ => {
  ...
  describe('Radio group', () => {
    it('create', done => {
      vm = createVue({
        template: `
          <${prefix}-radio-group v-model="radio">
            <${prefix}-radio :label="3" ref="radio1">备选项</${prefix}-radio>
            <${prefix}-radio :label="6" ref="radio2">备选项</${prefix}-radio>
            <${prefix}-radio :label="9">备选项</${prefix}-radio>
          </${prefix}-radio-group>
        `,
        data() {
          return {
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <${prefix}-radio-group v-model="radio" disabled>
            <${prefix}-radio :label="3" ref="radio1">备选项</${prefix}-radio>
            <${prefix}-radio :label="6" ref="radio2">备选项</${prefix}-radio>
            <${prefix}-radio :label="9">备选项</${prefix}-radio>
          </${prefix}-radio-group>
    ...
    it('change event', done => {
      vm = createVue({
        template: `
          <${prefix}-radio-group v-model="radio" @change="onChange">
            <${prefix}-radio :label="3">备选项</${prefix}-radio>
            <${prefix}-radio :label="6" ref="radio2">备选项</${prefix}-radio>
            <${prefix}-radio :label="9">备选项</${prefix}-radio>
          </${prefix}-radio-group>
        `,
    ...
    it('change event only triggers on user input', done => {
      vm = createVue({
        template: `
          <${prefix}-radio-group v-model="radio" @change="onChange">
            <${prefix}-radio :label="3">备选项</${prefix}-radio>
            <${prefix}-radio :label="6">备选项</${prefix}-radio>
            <${prefix}-radio :label="9">备选项</${prefix}-radio>
          </${prefix}-radio-group>
        `,
        methods: {
    ...
    it('disabled when children is radio button', done => {
      vm = createVue({
        template: `
          <${prefix}-radio-group v-model="radio" disabled>
            <${prefix}-radio-button :label="3" ref="radio1">备选项</${prefix}-radio-button>
            <${prefix}-radio-button :label="6" ref="radio2">备选项</${prefix}-radio-button>
            <${prefix}-radio-button :label="9">备选项</${prefix}-radio-button>
          </${prefix}-radio-group>
        `,
        data() {
          return {
    ...
    it('keyboard event', done => {
      vm = createVue({
        template: `
          <${prefix}-radio-group v-model="radio">
            <${prefix}-radio-button ref="radio1" :label="3">备选项</${prefix}-radio-button>
            <${prefix}-radio-button ref="radio2" :label="6">备选项</${prefix}-radio-button>
            <${prefix}-radio-button ref="radio3" :label="9">备选项</${prefix}-radio-button>
          </${prefix}-radio-group>
        `,
        data() {
          return {
    ...
    describe('Radio Button', () => {
      ...
      it('custom color', done => {
        vm = createVue({
          template: `
            <${prefix}-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <${prefix}-radio-button :label="3" ref="radio1">备选项</${prefix}-radio-button>
              <${prefix}-radio-button :label="6" ref="radio2">备选项</${prefix}-radio-button>
              <${prefix}-radio-button :label="9">备选项</${prefix}-radio-button>
            </${prefix}-radio-group>
      ...
      it('change event', done => {
        vm = createVue({
          template: `
            <${prefix}-radio-group v-model="radio" @change="onChange">
              <${prefix}-radio-button :label="3">备选项</${prefix}-radio-button>
              <${prefix}-radio-button :label="6" ref="radio2">备选项</${prefix}-radio-button>
              <${prefix}-radio-button :label="9">备选项</${prefix}-radio-button>
            </${prefix}-radio-group>
          `,
      ...
      it('size', done => {
        vm = createVue({
          template: `
            <${prefix}-radio-group v-model="radio" size="large">
              <${prefix}-radio-button :label="3" ref="radio1">备选项</${prefix}-radio-button>
              <${prefix}-radio-button :label="6" ref="radio2">备选项</${prefix}-radio-button>
              <${prefix}-radio-button :label="9">备选项</${prefix}-radio-button>
            </${prefix}-radio-group>
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll(`.${prefix}-radio-button--large`).length).to.be.equal(3);
          done();
        }, 10);
      });
    });
