...
树是可视化的结构分层， 分支可以展开或折叠，可单选、多选，可异步加载。
...
:::demo
```html
<hf-ui-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></hf-ui-tree>
...
<div class="hf-ui-tree-demo">
  ...
  <div class="buttons">
    <hf-ui-button size="medium" type="secondary" @click="getCheckedNodes">通过 node 获取</hf-ui-button>
    <hf-ui-button size="medium" type="secondary" @click="getCheckedKeys">通过 key 获取</hf-ui-button>
    <hf-ui-button size="medium" type="secondary" @click="setCheckedNodes">通过 node 设置</hf-ui-button>
    <hf-ui-button size="medium" type="secondary" @click="setCheckedKeys">通过 key 设置</hf-ui-button>
    <hf-ui-button size="medium" type="secondary" @click="resetChecked">清空</hf-ui-button>
  </div>
</div>
